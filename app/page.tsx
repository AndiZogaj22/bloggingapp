...
export default function Home() {
  ...
  return (
    <div className="absolute inset-0 bg-white bg-[linear-gradient(to_right,#8080800a_1px,transparent_1px),linear-gradient(to_bottom,#8080800a_1px,transparent_1px)] bg-[size:14px_24px] h-full overflow-y-auto">
      <main className="wrapper mx-auto h-screen w-9/12">
        ...
        <section className='py-10 '>
          ...
          <div className='py-2 md:ml-4 lg:ml-96 '>
            {blogs.map(blog => (
